      ...
      <div class="nk-nav-scroll">
        <ul class="metismenu" id="menu">
          ...
          <li>
            ...
            <li class="nav-label">Organization Users</li>
            <li>
              <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                <i class="fas fa-users"></i><span class="nav-text">Organization Users</span>
              </a>
              <ul aria-expanded="false">
                <li><a href="org_users.php">Organization Users</a></li>
                <li><a href="org_user_add.php">Organization User Add</a></li>
              </ul>
            </li>
